...
class LocalCache(object):
    ...
    def save_data(self, pid: int, content: bytes) -> None:
...
class DataStore(object):
    ...
    def set_cache(self, cache: LocalCache):
        self.cache = cache

    def set_remote(self, api):
        self.remote = api

    def get_data(self, pid: int) -> CaseManager:
